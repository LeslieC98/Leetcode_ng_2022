...
- 分层遍历
  - 一层一层的遍历一个图/树/矩阵
  - 简单图最短路径：**简单图**：图中所有边长一样，从起点走到终点最短路是？
- 连通快问题
  - 通过图中的一个点找到其他所有联通的点 A-->B, B-->C=>A--->B--->C
  - 找所有方案
- 拓扑排序
  - 有向图：A可以到B，B不一定到A
...
![image-20221105162944277](/Users/lesliecheung/Library/Application Support/typora-user-images/image-20221105162944277.png)
